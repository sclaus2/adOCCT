...
TEST(Test_Geom_BSplineCurve, ad_sensitivity_wrt_pole_coordinate_x)
{
  std::vector<Standard_Real> design_parameters = {0.0, 1.0, 2.0};

  /*
   * independent variable: design_parameters[0]
   */
  int independent_idx = 0;
  // set AD seed
...
TEST(Test_Geom_BSplineCurve, ad_sensitivity_wrt_pole_coordinate_y)
{
  std::vector<Standard_Real> design_parameters = {0.0, 1.0, 2.0};
...
TEST(Test_Geom_BSplineCurve, ad_sensitivity_wrt_pole_coordinate_z)
{
  std::vector<Standard_Real> design_parameters = {0.0, 1.0, 2.0};
