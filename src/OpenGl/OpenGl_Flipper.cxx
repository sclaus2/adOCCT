...
OpenGl_Flipper::OpenGl_Flipper(const gp_Ax2& theReferenceSystem)
    : OpenGl_Element(),
      myReferenceOrigin((Standard_ShortReal)getPrimal(theReferenceSystem.Location().X()),
                        (Standard_ShortReal)getPrimal(theReferenceSystem.Location().Y()),
                        (Standard_ShortReal)getPrimal(theReferenceSystem.Location().Z()),
                        1.0f),
      myReferenceX((Standard_ShortReal)getPrimal(theReferenceSystem.XDirection().X()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.XDirection().Y()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.XDirection().Z()),
                   1.0f),
      myReferenceY((Standard_ShortReal)getPrimal(theReferenceSystem.YDirection().X()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.YDirection().Y()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.YDirection().Z()),
                   1.0f),
      myReferenceZ((Standard_ShortReal)getPrimal(theReferenceSystem.Axis().Direction().X()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.Axis().Direction().Y()),
                   (Standard_ShortReal)getPrimal(theReferenceSystem.Axis().Direction().Z()),
                   1.0f),
