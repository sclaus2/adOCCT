...
static gp_Pnt findCommonPoint(const TopoDS_Shape& E1, const TopoDS_Shape& E2)
{
  ...
  gp_Pnt       common;
  const double d1121 = getPrimal(p11.SquareDistance(p21));
  const double d1122 = getPrimal(p11.SquareDistance(p22));
  const double d1221 = getPrimal(p12.SquareDistance(p21));
  const double d1222 = getPrimal(p12.SquareDistance(p22));
