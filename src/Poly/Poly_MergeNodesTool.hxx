...
public:
  ...
  NCollection_Vec3<float> computeTriNormal() const
  {
    ...
    NCollection_Vec3<float> aNorm((float)getPrimal(aCross.X()),
                                  (float)getPrimal(aCross.Y()),
                                  (float)getPrimal(aCross.Z()));
...
private:
  ...
  void pushNodeCheck(bool& theIsOpposite, const int theTriNode)
  {
    ...
    const NCollection_Vec3<float> aVec3((float)getPrimal(aPlace.X()),
                                        (float)getPrimal(aPlace.Y()),
                                        (float)getPrimal(aPlace.Z()));
