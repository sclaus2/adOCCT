...
public:
  ...
  Standard_EXPORT static double AnyToLS (const double aData, const Standard_CString aUnit, Handle(Units_Dimensions)& aDim);
  ...
  //! Converts the local unit value to the SI system units value.
  //! and gives the associated dimension of the unit
  Standard_EXPORT static double AnyToSI (const double aData, const Standard_CString aUnit, Handle(Units_Dimensions)& aDim);
  ...
  Standard_EXPORT static double CurrentToAny (const double aData, const Standard_CString aQuantity, const Standard_CString aUnit);
  ...
  Standard_EXPORT static double CurrentFromAny (const double aData, const Standard_CString aQuantity, const Standard_CString aUnit);
  
  //! Converts the local unit value to another local unit value.
  //! Example: AnyToAny(0.0254,"in.","millimeter") returns 1. ;
  Standard_EXPORT static double AnyToAny (const double aData, const Standard_CString aUnit1, const Standard_CString aUnit2);
