...
double UnitsAPI::CurrentToLS(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
...
double UnitsAPI::CurrentToSI(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
...
double UnitsAPI::CurrentFromLS(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
  CheckLoading(localSystem);
  if (CurrentUnits->Find(aQuantity))
...
double UnitsAPI::CurrentFromSI(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
  CheckLoading(UnitsAPI_DEFAULT);
  if (CurrentUnits->Find(aQuantity))
...
double UnitsAPI::AnyToLS(const double aData, const Standard_CString aUnit)
{
  double aValue = aData;
  CheckLoading(localSystem);
...
double UnitsAPI::AnyToSI(const double aData, const Standard_CString aUnit)
{
  double aValue;
  CheckLoading(UnitsAPI_DEFAULT);
...
double UnitsAPI::AnyFromLS(const double aData, const Standard_CString aUnit)
{
  double aValue = aData;
  CheckLoading(localSystem);
  Handle(Units_Dimensions) aDim;
...
double UnitsAPI::AnyFromSI(const double aData, const Standard_CString aUnit)
{
  double aValue;
  CheckLoading(UnitsAPI_DEFAULT);
...
double UnitsAPI::LSToSI(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
  CheckLoading(localSystem);
  if (CurrentUnits->Find(aQuantity))
...
double UnitsAPI::SIToLS(const double aData, const Standard_CString aQuantity)
{
  double aValue = aData;
  CheckLoading(localSystem);
  if (CurrentUnits->Find(aQuantity))
