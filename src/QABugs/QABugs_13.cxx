...
static Standard_Integer OCC817 (Draw_Interpretor& di, Standard_Integer argc, const char** argv)
{
  ...
  Standard_Integer NumXsubvolumes = (Standard_Integer)Standard_Real((Xmax - Xmin) / mesh_delt); if (NumXsubvolumes <= 0) NumXsubvolumes = 1;
  Standard_Integer NumYsubvolumes = (Standard_Integer)Standard_Real((Ymax - Ymin) / mesh_delt); if (NumYsubvolumes <= 0) NumYsubvolumes = 1;
  Standard_Integer NumZsubvolumes = (Standard_Integer)Standard_Real((Zmax - Zmin) / mesh_delt); if (NumZsubvolumes <= 0) NumZsubvolumes = 1;
