...
void AIS_ViewController::KeyUp(Aspect_VKey theKey, Standard_Real theTime)
{
                                    ...
                                    const gp_Pnt*             thePnt)
{
  ...
  if (thePnt != NULL)
  {
    ...
    const Graphic3d_Vec2d aPanFromCenterPx(Standard_Real(theParams.Point.x()) - 0.5 * aWinSizeF.x(),
                                           aWinSizeF.y() - Standard_Real(theParams.Point.y()) - 1.0
                                             - 0.5 * aWinSizeF.y());
