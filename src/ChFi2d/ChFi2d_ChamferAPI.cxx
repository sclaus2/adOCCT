                                      ...
                                      const Standard_Real theLength1, const Standard_Real theLength2) 
{
  ...
  Standard_Real aCommon1 = (myCommonStart1?myStart1:myEnd1) + (((myStart1 > myEnd1)^myCommonStart1)?theLength1:Standard_Real(-theLength1));
  Standard_Real aCommon2 = (myCommonStart2?myStart2:myEnd2) + (((myStart2 > myEnd2)^myCommonStart2)?theLength2:Standard_Real(-theLength2));
