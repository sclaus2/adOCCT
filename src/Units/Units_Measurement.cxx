...
Units_Measurement::Units_Measurement(const double avalue, const Handle(Units_Token)& atoken)
{
...
Units_Measurement::Units_Measurement(const double avalue, const Standard_CString aunit)
{
  themeasurement = avalue;
