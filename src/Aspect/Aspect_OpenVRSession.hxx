...
public:
  ...
  Standard_EXPORT virtual NCollection_Mat4<Standard_Real> EyeToHeadTransform(
    Aspect_Eye theEye) const Standard_OVERRIDE;

  //! Return projection matrix.
  Standard_EXPORT virtual NCollection_Mat4<Standard_Real> ProjectionMatrix(
    Aspect_Eye    theEye,
