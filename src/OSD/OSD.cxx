...
Standard_Boolean OSD::RealToCString(const double aReal, Standard_PCharacter& aString)
{
  char *p, *q;
...
Standard_Boolean OSD::CStringToReal(const Standard_CString aString, double& aReal)
{
  char* endptr;
