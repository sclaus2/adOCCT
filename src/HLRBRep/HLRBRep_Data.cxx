...
// Linux warning :  assignment to `int' from `double'. Cast has been added.
    EdgeMin.Min[0] = (Standard_Integer)Standard_Real( (myDeca[ 0] + TotMin[ 0]) * mySurD[ 0]);
    EdgeMax.Min[0] = (Standard_Integer)Standard_Real( (myDeca[ 0] + TotMax[ 0]) * mySurD[ 0]);
    EdgeMin.Min[1] = (Standard_Integer)Standard_Real( (myDeca[ 1] + TotMin[ 1]) * mySurD[ 1]);
    EdgeMax.Min[1] = (Standard_Integer)Standard_Real( (myDeca[ 1] + TotMax[ 1]) * mySurD[ 1]);
    EdgeMin.Min[2] = (Standard_Integer)Standard_Real( (myDeca[ 2] + TotMin[ 2]) * mySurD[ 2]);
    EdgeMax.Min[2] = (Standard_Integer)Standard_Real( (myDeca[ 2] + TotMax[ 2]) * mySurD[ 2]);
    EdgeMin.Min[3] = (Standard_Integer)Standard_Real( (myDeca[ 3] + TotMin[ 3]) * mySurD[ 3]);
    EdgeMax.Min[3] = (Standard_Integer)Standard_Real( (myDeca[ 3] + TotMax[ 3]) * mySurD[ 3]);
    EdgeMin.Min[4] = (Standard_Integer)Standard_Real( (myDeca[ 4] + TotMin[ 4]) * mySurD[ 4]);
    EdgeMax.Min[4] = (Standard_Integer)Standard_Real( (myDeca[ 4] + TotMax[ 4]) * mySurD[ 4]);
    EdgeMin.Min[5] = (Standard_Integer)Standard_Real( (myDeca[ 5] + TotMin[ 5]) * mySurD[ 5]);
    EdgeMax.Min[5] = (Standard_Integer)Standard_Real( (myDeca[ 5] + TotMax[ 5]) * mySurD[ 5]);
    EdgeMin.Min[6] = (Standard_Integer)Standard_Real( (myDeca[ 6] + TotMin[ 6]) * mySurD[ 6]);
    EdgeMax.Min[6] = (Standard_Integer)Standard_Real( (myDeca[ 6] + TotMax[ 6]) * mySurD[ 6]);
    EdgeMin.Min[7] = (Standard_Integer)Standard_Real( (myDeca[ 7] + TotMin[ 7]) * mySurD[ 7]);
    EdgeMax.Min[7] = (Standard_Integer)Standard_Real( (myDeca[ 7] + TotMax[ 7]) * mySurD[ 7]);
    EdgeMin.Max[0] = (Standard_Integer)Standard_Real( (myDeca[ 8] + TotMin[ 8]) * mySurD[ 8]);
    EdgeMax.Max[0] = (Standard_Integer)Standard_Real( (myDeca[ 8] + TotMax[ 8]) * mySurD[ 8]);
    EdgeMin.Max[1] = (Standard_Integer)Standard_Real( (myDeca[ 9] + TotMin[ 9]) * mySurD[ 9]);
    EdgeMax.Max[1] = (Standard_Integer)Standard_Real( (myDeca[ 9] + TotMax[ 9]) * mySurD[ 9]);
    EdgeMin.Max[2] = (Standard_Integer)Standard_Real( (myDeca[10] + TotMin[10]) * mySurD[10]);
    EdgeMax.Max[2] = (Standard_Integer)Standard_Real( (myDeca[10] + TotMax[10]) * mySurD[10]);
    EdgeMin.Max[3] = (Standard_Integer)Standard_Real( (myDeca[11] + TotMin[11]) * mySurD[11]);
    EdgeMax.Max[3] = (Standard_Integer)Standard_Real( (myDeca[11] + TotMax[11]) * mySurD[11]);
    EdgeMin.Max[4] = (Standard_Integer)Standard_Real( (myDeca[12] + TotMin[12]) * mySurD[12]);
    EdgeMax.Max[4] = (Standard_Integer)Standard_Real( (myDeca[12] + TotMax[12]) * mySurD[12]);
    EdgeMin.Max[5] = (Standard_Integer)Standard_Real( (myDeca[13] + TotMin[13]) * mySurD[13]);
    EdgeMax.Max[5] = (Standard_Integer)Standard_Real( (myDeca[13] + TotMax[13]) * mySurD[13]);
    EdgeMin.Max[6] = (Standard_Integer)Standard_Real( (myDeca[14] + TotMin[14]) * mySurD[14]);
    EdgeMax.Max[6] = (Standard_Integer)Standard_Real( (myDeca[14] + TotMax[14]) * mySurD[14]);
    EdgeMin.Max[7] = (Standard_Integer)Standard_Real( (myDeca[15] + TotMin[15]) * mySurD[15]);
    EdgeMax.Max[7] = (Standard_Integer)Standard_Real( (myDeca[15] + TotMax[15]) * mySurD[15]);
...
{
  theVertMin.Min[0] = (Standard_Integer)Standard_Real((theDeca[ 0]+theTotMin[ 0]) * theSurD[ 0]);
  theVertMax.Min[0] = (Standard_Integer)Standard_Real((theDeca[ 0]+theTotMax[ 0]) * theSurD[ 0]);
  theVertMin.Min[1] = (Standard_Integer)Standard_Real((theDeca[ 1]+theTotMin[ 1]) * theSurD[ 1]);
  theVertMax.Min[1] = (Standard_Integer)Standard_Real((theDeca[ 1]+theTotMax[ 1]) * theSurD[ 1]);
  theVertMin.Min[2] = (Standard_Integer)Standard_Real((theDeca[ 2]+theTotMin[ 2]) * theSurD[ 2]);
  theVertMax.Min[2] = (Standard_Integer)Standard_Real((theDeca[ 2]+theTotMax[ 2]) * theSurD[ 2]);
  theVertMin.Min[3] = (Standard_Integer)Standard_Real((theDeca[ 3]+theTotMin[ 3]) * theSurD[ 3]);
  theVertMax.Min[3] = (Standard_Integer)Standard_Real((theDeca[ 3]+theTotMax[ 3]) * theSurD[ 3]);
  theVertMin.Min[4] = (Standard_Integer)Standard_Real((theDeca[ 4]+theTotMin[ 4]) * theSurD[ 4]);
  theVertMax.Min[4] = (Standard_Integer)Standard_Real((theDeca[ 4]+theTotMax[ 4]) * theSurD[ 4]);
  theVertMin.Min[5] = (Standard_Integer)Standard_Real((theDeca[ 5]+theTotMin[ 5]) * theSurD[ 5]);
  theVertMax.Min[5] = (Standard_Integer)Standard_Real((theDeca[ 5]+theTotMax[ 5]) * theSurD[ 5]);
  theVertMin.Min[6] = (Standard_Integer)Standard_Real((theDeca[ 6]+theTotMin[ 6]) * theSurD[ 6]);
  theVertMax.Min[6] = (Standard_Integer)Standard_Real((theDeca[ 6]+theTotMax[ 6]) * theSurD[ 6]);
  theVertMin.Min[7] = (Standard_Integer)Standard_Real((theDeca[ 7]+theTotMin[ 7]) * theSurD[ 7]);
  theVertMax.Min[7] = (Standard_Integer)Standard_Real((theDeca[ 7]+theTotMax[ 7]) * theSurD[ 7]);
  theVertMin.Max[0] = (Standard_Integer)Standard_Real((theDeca[ 8]+theTotMin[ 8]) * theSurD[ 8]);
  theVertMax.Max[0] = (Standard_Integer)Standard_Real((theDeca[ 8]+theTotMax[ 8]) * theSurD[ 8]);
  theVertMin.Max[1] = (Standard_Integer)Standard_Real((theDeca[ 9]+theTotMin[ 9]) * theSurD[ 9]);
  theVertMax.Max[1] = (Standard_Integer)Standard_Real((theDeca[ 9]+theTotMax[ 9]) * theSurD[ 9]);
  theVertMin.Max[2] = (Standard_Integer)Standard_Real((theDeca[10]+theTotMin[10]) * theSurD[10]);
  theVertMax.Max[2] = (Standard_Integer)Standard_Real((theDeca[10]+theTotMax[10]) * theSurD[10]);
  theVertMin.Max[3] = (Standard_Integer)Standard_Real((theDeca[11]+theTotMin[11]) * theSurD[11]);
  theVertMax.Max[3] = (Standard_Integer)Standard_Real((theDeca[11]+theTotMax[11]) * theSurD[11]);
  theVertMin.Max[4] = (Standard_Integer)Standard_Real((theDeca[12]+theTotMin[12]) * theSurD[12]);
  theVertMax.Max[4] = (Standard_Integer)Standard_Real((theDeca[12]+theTotMax[12]) * theSurD[12]);
  theVertMin.Max[5] = (Standard_Integer)Standard_Real((theDeca[13]+theTotMin[13]) * theSurD[13]);
  theVertMax.Max[5] = (Standard_Integer)Standard_Real((theDeca[13]+theTotMax[13]) * theSurD[13]);
  theVertMin.Max[6] = (Standard_Integer)Standard_Real((theDeca[14]+theTotMin[14]) * theSurD[14]);
  theVertMax.Max[6] = (Standard_Integer)Standard_Real((theDeca[14]+theTotMax[14]) * theSurD[14]);
  theVertMin.Max[7] = (Standard_Integer)Standard_Real((theDeca[15]+theTotMin[15]) * theSurD[15]);
  theVertMax.Max[7] = (Standard_Integer)Standard_Real((theDeca[15]+theTotMax[15]) * theSurD[15]);
}
