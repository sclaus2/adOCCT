  ...
  else // OffsetSurface
  {
    ...
    else // Offset Line, Parab, Hyperb
    {
      ...
      if (GACT != GeomAbs_Hyperbola)
      {
        ...
        {
          VmTr = FirstV;
          VMTr = ((LastV - FirstV) > 1.e+4) ? Standard_Real(FirstV + 1.e+4) : LastV;
        }
        else if (FirstV < 0. && LastV < 0.)
        {
          VMTr = LastV;
          VmTr = ((FirstV - LastV) < -1.e+4) ? Standard_Real(LastV - 1.e+4) : FirstV;
        }
        else
        {
          VmTr = (FirstV < -1.e+4) ? Standard_Real(-1.e+4) : FirstV;
  ...
  else // OffsetSurface
  {
    ...
    else // Offset Line, Parab, Hyperb
    {
      ...
      if (GACT != GeomAbs_Hyperbola)
      {
        ...
        {
          UmTr = FirstU;
          UMTr = ((LastU - FirstU) > 1.e+4) ? Standard_Real(FirstU + 1.e+4) : LastU;
        }
        else if (FirstU < 0. && LastU < 0.)
        {
          UMTr = LastU;
          UmTr = ((FirstU - LastU) < -1.e+4) ? Standard_Real(LastU - 1.e+4) : FirstU;
        }
        else
        {
          UmTr = (FirstU < -1.e+4) ? Standard_Real(-1.e+4) : FirstU;
